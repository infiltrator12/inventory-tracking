...
<body>
    <div class="header">
        ...
        <a href="/inventory_Tracking/php/catalog.php"><strong>LAPTOPS</strong></a>
    ...
    <div id="main">
        ...
        <div id="editFormContainer" style="display: none;" class="modal">
            <h3>Edit Data</h3>
            <form id="editForm" method="POST" action="/inventory_Tracking/php/catalogdatabase.php?function=update" class="modal-content animate container-add">
                <a href="javascript:void(0)" class="closebtn" onclick="closeForm()">&times;</a><br>
                <label for="ID">SERIAL NUMBER:</label><br>
                <input type="text" id="editserialnumber" name="editserialnumber"><br>

                <label for="editName">ASSET TAG:</label><br>
                <input type="text" id="editassettag" name="editassettag"><br>
                ...
                <input type="text" id="editstoragecapacity" name="editstoragecapacity"><br>
                ...
                <input type="text" id="editramcapacity" name="editramcapacity"><br>

                <label for="RAM_CAPACITY">EMPLOYEE NAME:</label><br>
                <input type="text" id="editemployeename" name="employeename" required /><br>

                <label for="RAM_CAPACITY">EMPLOYEE NUMBER:</label><br>
                <input type="text" id="editemployeenumber" name="employeenumber" required /><br>

                <label for="DEPARTMENT">DEPARTMENT:</label><br>
                <input type="text" id="editdepartment" name="department" required /><br>

                <label for="DEPARTMENT">DATE ISSUED:</label><br>
                <input type="date" id="editdateissued" name="dateissued" /><br>

                <label for="DEVICE CONDITION">DEVICE CONDITION:</label><br>
                <input type="text" id="editdevicecondition" name="editdevicecondition"><br>

                <label for="Allocation">ALLOCATION:</label><br>
                <input type="text" id="editallocation" name="editAllocation"><br>
                ...
                <table id="mytable">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td>" . $row['devicecondition'] . "</td>";
...
<script src="/inventory_Tracking/scripts/catalog.js"></script>
