...
<body class="body">
    <div class="header">
        ...
        <div class="top">
            <a href="/inventory_Tracking/php/userdashboard.php" class="logo"><img
                    src="/inventory_Tracking/assets/interswitch_logo.svg" width="200px" height="70px"></a>
        </div>
        <a href="/inventory_Tracking/php/userdashboard.php"><strong>DASHBOARD</strong></a>
    ...
    <div id="main">
        <div class="sidenav" id="Sidenav">
            ...
            <div class="bottom">
                <a href="/inventory_Tracking/php/userdashboard.php" id="dashboard"><i class="fa fa-tachometer"
        ...
        <div class="element">
            ...
            <div class="change">
                ...
                <a href="/inventory_Tracking/php/devices.php" id="printers"><i class="fa-solid fa-print fa-3x"></i></a>
                <a href="/inventory_Tracking/php/pservers.php" id="monitors"><i
                        class="fa-solid fa-server fa-3x"></i></i></a>
            </div>
        </div>
        <div class="devicelist">
            <div class="devicelist1">
                ...
                $count3 = $row['count'];
                ?>
                <i class="fa fa-users fa-7x" aria-hidden="true"></i><br>
